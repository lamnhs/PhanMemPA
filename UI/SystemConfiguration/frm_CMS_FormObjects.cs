...
{
    public partial class frm_CMS_FormObjects : Form
    {
        #region Variables
        ...
        private void frm_CMS_FormObjects_Load(object sender, EventArgs e)
        {
            #region Phân quyền
        ...
        {
            rm = new ResourceManager("CMSUI.Lang.MyResource", typeof(frm_CMS_FormObjects).Assembly);
            ...
            layoutControlItemForm.Text = rm.GetString("layoutControlItemForm", CMSUser._culture);
        }
        ...
        private void GetForm()
        {
            try
            {
                DataTable dtForm = BL_HeThong.GetForm();
                AppDevExpressEditControl.InitLookUpEdit(lookUpEditForm, dtForm, "FormName", "FormID", string.Empty, "FormID,FormName", "ID," + rm.GetString("layoutControlItemForm", CMSUser._culture), 0);
            }
            catch (Exception ex)
            {
        ...
        private void GetData()
        {
            try
            {
                _dtData = BL_HeThong.GetFormObject(lookUpEditForm.EditValue.ToString());
                ...
                DataRow _drGrids = (DataRow)dtGrid.Select("GridID = 'HT-HT-DoiTuong'").GetValue(0);
        ...
        {
            frm_CMS_FormObjects_Load(null, null);
        }
